//package com.googoo.springbatch;
//
...
//public class Batch {
//
//    Job job(JobBuilderFactory jbf, StepBuilderFactory sbf, Step1 step1, Step2 step2) throws Exception{
//
//        Step s1 = sbf.get("file-db").
//                <Student,Student>chunk(100).
//                reader(step1.findReader(null)).
